      ...
      <div className="min-h-screen w-full border-b border-black bg-[#ececec] text-[#1c1a17] flex flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-1/2 p-10 lg:p-20 flex items-center justify-center">
          ...
          >
            <div>
              <input
                className="border-b border-[#1c1a17] px-4 py-4 bg-transparent outline-none w-full"
                placeholder="Name"
                name="name"
                type="text"
                value={form.name}
            ...
            <div>
              <textarea
                className="border-b border-[#1c1a17] px-4 py-4 bg-transparent min-h-[150px] resize-none outline-none w-full"
                placeholder="Message"
                name="message"
                value={form.message}
                onChange={handleChange}
            ...
            <button
              type="submit"
              className="self-start cursor-pointer mt-4 border-2 font-semibold rounded-[2px] border-[#1c1a17] px-6 py-2 hover:scale-103 transition-transform ease-in-out"
            >
              Send
            </button>
          </motion.form>
